...
class ResponsibilityPerformanceUnit(str, Enum):
    """Performance measurement units for responsibilities."""
...
class ResponsibilityTask(db.Model):
    ...
    perf_responsible_value = db.Column(db.Numeric(18, 4), nullable=False, default=0)
    perf_actual_value = db.Column(db.Numeric(18, 4), nullable=False, default=0)
    perf_metric_value = db.Column(db.Numeric(6, 1), nullable=False, default=0)
